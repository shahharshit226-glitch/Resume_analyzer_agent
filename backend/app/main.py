...
# """
# AI-Powered Resume Analyzer Backend - Lenient Scoring Version
# FastAPI application with NLP-based resume parsing and analysis
# Updated with 10 core skills per role and more lenient scoring
# """

# from main_with_email_agent import router as email_router
...
#     description="NLP-powered resume analysis system with lenient scoring",
#     version="2.0.0"
# )
...
# # Job Role Configurations - REDUCED TO 10 CORE SKILLS EACH
# JOB_ROLES = {
#     "software_engineer": {
...
# # Common technical skills for custom job descriptions
...
# def build_email_content(results: Dict) -> str:
#     score = results.get("overall_score", "N/A")
#     skills = results.get("matched_skills", [])
...
#         <p><b>Overall ATS Score:</b> {score}%</p>
...
#         <hr/>
#         <p style="color:gray;">Generated by AI Resume Analyzer</p>
#     </body>
#     </html>
#     """
#     return html
...
#     try:
#         # Use pdfplumber for more robust extraction
#         with pdfplumber.open(io.BytesIO(file_content)) as pdf:
#             text = "\n".join(page.extract_text() or "" for page in pdf.pages)
#         # Fallback: If text is empty, try PyPDF2 as backup
#         if not text.strip():
...
#             text = '\n'.join(text_chunks)
#         print("[PDF Extracted Text Preview]", text[:500])
#         return text
...
#             return file_content
#         else:
#             raise ValueError("Unsupported TXT file content type")
#     except Exception as e:
...
#     """Extract skills from job description - limited to 10"""
...
#     """Extract action keywords from job description"""
#     common_action_verbs = [
#         "develop", "design", "implement", "manage", "lead", "build",
#         "optimize", "analyze", "collaborate", "drive"
#     ]
...
#     """
#     Extract skills from resume - MORE LENIENT
...
#         # Check exact match or if skill is part of a word
#         if skill_lower in text_lower:
#             found_skills.append(skill)
#             continue
        
#         # Check variations (e.g., "react" matches "reactjs", "react.js")
...
#     """Extract years of experience - MORE LENIENT"""
#     pattern = r'(\d+)\+?\s*years?'
...
#     # Default to 2 years if not found (more lenient)
#     return 2

# def calculate_ats_score(text: str) -> int:
#     """
#     Calculate ATS compatibility score - MORE LENIENT
#     Base score starts at 40 instead of 0
#     """
#     score = 40  # Start with base score
#     text_lower = text.lower()
    
#     # Check for standard resume sections (30 points)
#     sections_found = 0
#     for section in ATS_POSITIVE_INDICATORS:
#         if section in text_lower:
#             sections_found += 1
    
#     score += min(sections_found * 4, 30)
    
#     # Check for structured formatting (15 points)
#     if '•' in text or '-' in text or '\n' in text:
#         score += 15
    
#     # Check for proper capitalization (5 points)
#     if any(c.isupper() for c in text):
#         score += 5
    
#     # Check for email and phone (5 points each)
...
#     """
#     Calculate skills match - MORE LENIENT
#     Bonus points for having any skills at all
#     """
...
#     # Bonus: Add 10 points if at least 3 skills found
#     if len(found_skills) >= 3:
#         match_percentage += 10
    
#     # Bonus: Add 5 points if at least 1 skill found
...
#     """
#     Calculate experience strength - MORE LENIENT
...
#         score += 20
#     else:
#         score += 15  # Even 0 years gets some points
    
#     # Action verbs and achievements (40 points)
#     keyword_count = 0
...
#     """
#     Calculate formatting quality - MORE LENIENT
#     Base score starts at 50
#     """
#     score = 50  # Start with base score
    
#     # Check for sections (20 points)
#     sections = ['education', 'experience', 'skills', 'projects']
#     sections_found = sum([1 for s in sections if s in text.lower()])
...
#     # Check for proper spacing (10 points)
#     if '\n\n' in text or '\n' in text:
#         score += 10
    
#     # Check for professional appearance (5 points)
...
#     """
#     Calculate keyword optimization - MORE LENIENT
#     Base score starts at 40
#     """
#     text_lower = text.lower()
#     score = 40  # Start with base score
    
#     # Skills keywords (35 points)
...
#     actions_found = sum([1 for keyword in keywords if keyword.lower() in text_lower])
#     if keywords:
#         score += min((actions_found / len(keywords)) * 15, 15)
    
#     # Presence of any keywords (10 points)
#     if skills_found > 0 or actions_found > 0:
#         score += 10
    
#     return int(min(score, 100))

# ## Removed duplicate/old generate_suggestions definition (see below for the correct version)
    
#     # ATS suggestions
#     if scores['ats_compatibility'] < 70:
#         suggestions.append(
#             "🤖 Add standard section headings like 'Professional Experience', 'Education', and 'Skills' for better ATS compatibility."
#         )
    
#     # Experience suggestions
#     if scores['experience_strength'] < 70:
#         suggestions.append(
#             "💪 Strengthen your experience section by adding measurable achievements (e.g., 'Increased efficiency by 25%')."
#         )
    
#     # Formatting suggestions
#     if scores['formatting_quality'] < 75:
#         suggestions.append(
#             "📝 Improve readability with consistent bullet points and clear section headers."
#         )
    
#     # Keyword optimization
#     if scores['keyword_optimization'] < 70:
#         suggestions.append(
#             "🔍 Include more role-specific keywords from the job description throughout your resume."
#         )
...
#     if word_count < 200:
#         suggestions.append(
#             "📄 Your resume could benefit from more detail. Aim for 300-600 words to showcase your qualifications."
#         )
    
#     # Positive reinforcement
#     if scores['skills_match'] >= 60:
#         suggestions.append(
#             "✨ Great job! Your skills align well with the role. Keep highlighting your strengths."
#         )
...
# #     """Main analysis function with lenient scoring"""
# #     # Extract skills
# #     skills_analysis = extract_skills(text, job_config['required_skills'])
    
# #     # Calculate individual scores (all more lenient now)
# #     ats_score = calculate_ats_score(text)
# #     skills_match_score = calculate_skills_match_score(
# #         skills_analysis['found_skills'],
...
# #     keyword_score = calculate_keyword_optimization_score(
# #         text, job_config['required_skills'], job_config['keywords']
# #     )
...
# #     suggestions = generate_suggestions(text, skills_analysis, scores, job_config['name'])
...
# #         ],
# #         'contact_info_complete': bool(extract_email(text) and extract_phone(text))
# #     }
...
# #     return {
# #         "message": "AI Resume Analyzer API v2.0 - Lenient Scoring",
# #         "version": "2.0.0",
# #         "status": "active",
# #         "features": [
# #             "10 core skills per role",
...
# #                 "id": key,
# #                 "name": value["name"],
# #                 "skills_count": len(value["required_skills"])
# #             }
...
# #     Accepts either a predefined job_role OR a custom job_description
# #     """
# #     # Validate input
...
# #     if job_description:
# #         # Custom job description mode - extract only 10 skills
...
# #     import uvicorn
# #     print("🚀 Starting AI Resume Analyzer API - Lenient Scoring Version...")
# #     print("📝 10 core skills per role for easier matching")
# #     print("🌐 Server will be available at http://localhost:8000")
# #     print("📚 API docs at http://localhost:8000/docs")
# #     uvicorn.run(app, host="0.0.0.0", port=8000)

# """
# AI-Powered Resume Analyzer Backend - FIXED VERSION
...
# app = FastAPI(
#     title="AI Resume Analyzer",
#     description="NLP-powered resume analysis with enhanced summary extraction",
#     version="2.1.0"
# )
...
# # Job Role Configurations - 10 core skills each
# JOB_ROLES = {
#     "software_engineer": {
#         "name": "Software Engineer",
#         "required_skills": [
...
#     if job_name.lower() in text_lower:
#         return job_name
...
#         issues.append("Excessive punctuation marks (!! or ??)")
    
#     all_caps_pattern = r'\b[A-Z\s]{30,}\b'
#     if re.search(all_caps_pattern, text):
#         issues.append("Avoid using ALL CAPS for entire sentences")
...
# def calculate_completeness(name: str, email: str, phone: str, skills: List[str], achievements: List[str]) -> int:
#     score = 0
#     if name != "Not found":
#         score += 20
#     if email != "Not found":
...
# def extract_keywords_from_job_description(job_description: str) -> List[str]:
#     common_action_verbs = ["develop", "design", "implement", "manage", "lead", "build", "optimize", "analyze", "collaborate", "drive"]
#     jd_lower = job_description.lower()
#     found_keywords = []
#     for verb in common_action_verbs:
#         if verb in jd_lower:
...
#             found_skills.append(skill)
#             continue
#         if any(variation in text_lower for variation in [skill_lower.replace('.', ''), skill_lower.replace(' ', ''), skill_lower + 'js', skill_lower.replace('-', '')]):
#             found_skills.append(skill)
...
#     year_ranges = re.findall(r'(20\d{2})\s*[-–]\s*(20\d{2}|present)', text.lower())
#     if year_ranges:
#         total_years = sum([(2025 if end == 'present' else int(end)) - int(start) for start, end in year_ranges])
#         return total_years
#     return 2
...
#         suggestions.append(f"✍️ GRAMMAR: Fix these issues - {issues_text}")
...
#         suggestions.append("🏆 Add quantifiable achievements (e.g., 'Increased sales by 30%', 'Managed team of 5', 'Reduced costs by $10K')")
#     if scores['ats_compatibility'] < 70:
...
#         suggestions.append(f"🔍 Optimize for '{job_name}': Include role-specific keywords from job description naturally throughout resume")
#     word_count = len(text.split())
#     if word_count < 250:
#         suggestions.append(f"📄 Resume is too short ({word_count} words). Aim for 400-700 words with detailed descriptions of your work")
#     elif word_count > 900:
#         suggestions.append(f"✂️ Resume is too long ({word_count} words). Condense to 400-700 words, focusing on most relevant experiences")
#     if overall_score >= 75:
...
#     overall_score = int((ats_score * 0.20) + (skills_match_score * 0.30) + (experience_score * 0.25) + (formatting_score * 0.15) + (keyword_score * 0.10))
...
#         'years_of_experience': extract_experience_years(text),
#         'sections_found': [section for section in ['Professional Summary', 'Experience', 'Education', 'Skills', 'Projects'] if section.lower() in text.lower()],
...
#         html_content = build_email_content(data.analysis_results)
...
# async def root():
#     return {
#         "message": "AI Resume Analyzer API v2.1 - Enhanced Summary",
#         "version": "2.1.0",
#         "status": "active",
#         "features": [
#             "Detailed resume extraction",
#             "Grammar checking",
...
# if __name__ == "__app:main__":
#     import uvicorn
#     print("🚀 Starting AI Resume Analyzer API v2.1...")
#     print("📋 Enhanced with detailed extraction and grammar checking")
...
def generate_suggestions(text: str, skills_analysis: Dict, scores: Dict, overall_score: int, job_name: str, resume_summary: Dict) -> List[str]:
    ...
    if word_count < 250:
        ...
        suggestions.append(f"✂️ Resume is too long ({word_count} words). Condense to 400-700 words")
    if overall_score >= 75:
        suggestions.append(f"✨ Great work! Your resume scores {overall_score}/100. Keep refining based on above suggestions")
    return suggestions[:8]
