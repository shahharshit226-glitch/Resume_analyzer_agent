...
const DEMO = [
  { role: "Admin",   email: "admin@agentic.com",   pw: "admin123",   emoji: "👑", color: "from-indigo-500 to-purple-500" },
  { role: "HR",      email: "hr@agentic.com",       pw: "hr123",      emoji: "👥", color: "from-green-500 to-teal-500"   },
  { role: "Finance", email: "finance@agentic.com",  pw: "finance123", emoji: "💰", color: "from-amber-500 to-orange-500" },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-950 to-purple-900 flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-indigo-600 rounded-full filter blur-3xl opacity-20 animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-600 rounded-full filter blur-3xl opacity-20" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-indigo-200/70 text-sm mt-2">Sign in to your dashboard</p>
        </div>
        ...
        <p className="text-center text-white/25 text-xs mt-6">
          AI AgenticHire © 2026 · Enterprise Edition · Bhubaneswar, India
        </p>
      </div>
    </div>
  );
